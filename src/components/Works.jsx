    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          world example of my work. Each projec is briefly described with links
          to code repositories in it. It reflects my ability to solve complex
